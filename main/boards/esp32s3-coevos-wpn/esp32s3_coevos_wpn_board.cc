...
#define TAG "esp32s3_coevos_wpn"

LV_FONT_DECLARE(font_puhui_20_4);
LV_FONT_DECLARE(font_awesome_20_4);

class Esp32S3CoevosWpnBoard : public WifiBoard {
private:
    Button boot_button_;
    ...
    void Enbl()
    {
        ...
        gpio_set_level(DISPLAY_BACKLIGHT_PIN, DISPLAY_BACKLIGHT_OUTPUT_INVERT);
    }

    void InitializeSpi() {
        spi_bus_config_t buscfg = {};
        buscfg.mosi_io_num = GPIO_NUM_14;
        buscfg.miso_io_num = GPIO_NUM_NC;
        buscfg.sclk_io_num = GPIO_NUM_12;
        buscfg.quadwp_io_num = GPIO_NUM_NC;
        buscfg.quadhd_io_num = GPIO_NUM_NC;
        buscfg.max_transfer_sz = DISPLAY_WIDTH * DISPLAY_HEIGHT * sizeof(uint16_t)/10;
    ...
    void InitializeSt7789Display() {
        ...
        io_config.cs_gpio_num = GPIO_NUM_47;
        ...
        panel_config.reset_gpio_num = GPIO_NUM_1;
...
public:
    Esp32S3CoevosWpnBoard() : boot_button_(BOOT_BUTTON_GPIO) {
...
DECLARE_BOARD(Esp32S3CoevosWpnBoard);
